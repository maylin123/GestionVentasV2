...
namespace GestionVentasV2.Models
{
    public class categoria
    {
        ...
        [MaxLength(100, ErrorMessage = "El campo nombre sobrepasa el maximo de caracteres permitidos.")]
        public string nombre { get; set; }


        [Required(ErrorMessage = "El campo descripción es obligatorio")]
        [MaxLength(150, ErrorMessage = "El campo descripción sobrepasa el maximo de caracteres permitidos.")]
